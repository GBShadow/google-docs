  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center w-full ">
        ...
        <div
          className="mx-5 md:mx-20 hidden sm:flex flex-grow items-center px-5
      ...
      focus-within:text-gray-600 focus-within:shadow-md"
        >
          ...
          <input
            type="text"
            placeholder="Search"
            className="flex md:flex-grow px-5 text-base bg-transparent outline-none"
          />
        </div>
